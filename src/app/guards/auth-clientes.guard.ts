...
export class AuthClientesGuard implements CanActivate, CanActivateChild {
  constructor(private router: Router, private clientesService: ClientesService, private api: ApiService) {}
    ...
    async getProfile() {
        ...
        if (this.clientesService.cliente) { // let {email} = this.api.data;
